<template>
  ...
  <button :class="'button2 '+(filter=='University'? 'insert':'')" @click="filter='University'">
    University
  </button>
</template>
...
.button2{
  ...
  background:radial-gradient(ellipse, aquamarine 40%, white 90%) ;
...
.button2.insert{
   background:radial-gradient(ellipse, rgb(226, 14, 14) 60%, white 95%);
   color: white;
}
